(function () {
  ...
  const t = {
    en: {
      ...
      academicsPageSubtitle: "Nursery to Class XII under the Uttarakhand Board (UBSE), with Arts and Science streams in the Senior Wing.",
    ...
    hi: {
      ...
      academicsPageSubtitle: "उत्तराखंड बोर्ड (UBSE) से संबद्ध — नर्सरी से कक्षा XII तक, सीनियर विंग में कला और विज्ञान स्ट्रीम।",
